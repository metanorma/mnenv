...
=== Manage binary version data

[source,shell]
----
# Refresh binary version data from GitHub
mnenv binary refresh

# Re-fetch all binary versions
mnenv binary revamp

# List binary versions
mnenv binary list
----
...
│   └── BinaryCommand      # Manage binary version data
├── Installers/
